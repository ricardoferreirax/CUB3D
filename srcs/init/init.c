...
const t_lvl_config	g_lvl_config[21] = {{(t_elroy){.is_blinky = 1,
		.one.dots_left = 20, .one.speed_multiplier = 80, .two.dots_left = 10,
		.two.speed_multiplier = 85}, .ghost_speed = 75,
		.ghost_frightened_speed = 50, .ghost_tunnel_speed = 40,
		.pacman_speed = 80, .pacman_frightened_speed = 90,
		.frightened_time = 6.0, .bonus_fruit_points = 100},
		      {(t_elroy){.is_blinky = 1, .one.dots_left = 30,
		.one.speed_multiplier = 90, .two.dots_left = 15,
		.two.speed_multiplier = 95}, .ghost_speed = 85,
		.ghost_frightened_speed = 55, .ghost_tunnel_speed = 45,
		.pacman_speed = 90, .pacman_frightened_speed = 95,
		.frightened_time = 5.0, .bonus_fruit_points = 300},
										{(t_elroy){.is_blinky = 1,
											.one.dots_left = 40,
											.one.speed_multiplier = 90,
											.two.dots_left = 20,
											.two.speed_multiplier = 95},
											.ghost_speed = 85,
